...
- Close note records the **transforms carve-out**: `TransformEntry.matrix: Affine2D` e/f deferred to fulgur-1ino (still open); `origin: Point2` already Pt. So P2/fulgur-2map.8 must not read transforms as done.
